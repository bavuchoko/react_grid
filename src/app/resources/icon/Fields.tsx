...
const Fields = (props:IconType) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" style={props.style ?? {width:'18px'}} onClick={props.onClick} clip={props.className}  viewBox="0 0 24 24" fill="none"
